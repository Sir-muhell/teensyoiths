...
<html lang="en">
<head>
	<title><?php echo $_SESSION['Username'] ?> | TeensYouths</title>
	<meta charset="utf-8">
...
$data = $_SESSION['Username'];
	$sql = "SELECT * FROM user WHERE `usname` = '$data'";
	$res = query($sql);
	$row = mysqli_fetch_array($res);

	$_SESSION['pix'] = $row['pix'];

	if ($_SESSION['pix'] == "" || $_SESSION['pix'] == null) {
		
		echo '<section class="site-hero" style="background-image: url(../img/2.png);" id="section-home" data-stellar-background-ratio="0.5">';
	} else {

		echo '<section class="site-hero" style="background-image: url(userdp/'.$_SESSION['pix'].');" id="section-home" data-stellar-background-ratio="0.5">';
	}
...
?>	
					...
					<div class="single-portfolio col-sm-4 all mockup">
						<div class="relative">
							...
							<a href="images/p1.jpg" class="img-pop-up">  
								<div class="middle">
									<div class="text align-self-center d-flex"><img src="images/p1.jpg" alt=""></div>
								</div>
							</a>                                  
						</div>
						<div class="p-inner">
					...
					<div class="single-portfolio col-sm-4 all mockup">
						<div class="relative">
							...
							<a href="images/p2.jpg" class="img-pop-up">  
								<div class="middle">
									<div class="text align-self-center d-flex"><img src="images/p2.jpg" alt=""></div>
								</div>
							</a>                                  
						</div>
						<div class="p-inner">
 ...
 <!-- Modal -->
    <div class="modal fade" id="egModalCenter">
            ...
            <div style="background: #f9f9ff; color: #ff0000;" class="modal-content">
				...
				<div class="col-md-12 mb-5 mb-md-0">
					...
					<form action="" class="site-form" method="post">
						<h3 class="mb-4" style="color: black">Welcome <?php echo $_SESSION['Username'] ?></h3>
						<p id="msg">Let`s get this page tidy for you real quick</p>
						<div class="form-group">
							<input name="tw" type="text" style="color: white;" class="form-control px-3 py-4" placeholder="May I have your Twitter Handle? e.g; @samosalau">
						</div>
						<div class="form-group">
							<input name="ig" type="email" style="color: white;" class="form-control px-3 py-4" placeholder="How about your Instagram Handle? e.g @samsalau">
						</div>
						<div class="form-group">
							<input name="fb" type="text" style="color: white;" class="form-control px-3 py-4" placeholder="I`ll love have your Facebook username also? ">
						</div>
						<div class="form-group">
							<input name="fle" type="file" style="color: white;" class="form-control" required>
						</div>
						<div class="form-group mb-5">
							<textarea name="addrs" class="form-control px-3 py-4"cols="30" rows="10" placeholder="Let others get in touch with you. Please input your residential address" required></textarea>
						</div>
						<div class="row">
						<div class="form-group">
							<input type="submit" name="onnxt" class="btn btn-primary px-4 py-3" value="Done! Next please!">
							<input type="button" id="onskip" data-dismiss="modal" class="btn btn-primary px-4 py-3" value="I`ll do this later">
						</div>
					</div>
					</form>
				</div>
