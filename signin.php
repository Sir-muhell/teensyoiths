                        ...
                        <form method="post">
                            <div class="row">
                                ...
                                <div class="col-12 text-center">
                                    <a href="./forgot" style="color: red; text-decoration: none;"><p>Forgot Password? </a>| <a href="./signup" style="color: red; text-decoration: none;">Create an account</p></a>
                                    <button id="nxtSignin" type="button" class="btn crose-btn mt-15">Sign in</button>
                                </div>
